      ...
      {isOpen && (
        ...
        >
          ...
          <div className="w-full max-w-5xl px-4 md:px-6 mt-12 md:mt-0">
            ...
            <h2 className="text-2xl md:text-3xl font-serif text-secondary mb-6 md:mb-8 text-center">
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="p-2 md:p-3">
                            <h4 className="text-light text-xs md:text-sm font-medium line-clamp-1">
                              {product.name}
                            </h4>
                ...
                <div className="flex flex-wrap gap-2">
                  {recentSearches.map((term, index) => (
                    ...
                    >
                      <FiClock
                        size={14}
                        className="mr-1 md:mr-2 text-gray-500 group-hover:text-secondary transition-colors"
                      />
                      <button
