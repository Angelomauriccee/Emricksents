  ...
  const instagramReels = [
    {
      ...
      thumbnail:
        "https://res.cloudinary.com/drtmoxle9/image/upload/v1761048324/reel4_m0lbjl.jpg",
    },
    {
      id: 2,
      url: "https://www.instagram.com/reel/DOxhyh6jLkj/?igsh=YzljYTk1ODg3Zg==",
      thumbnail:
        "https://res.cloudinary.com/drtmoxle9/image/upload/v1761048319/reel1_l8jzu2.jpg",
    },
    {
      id: 3,
      url: "https://www.instagram.com/reel/DOs1GBdDFHQ/?igsh=YzljYTk1ODg3Zg==",
      thumbnail:
        "https://res.cloudinary.com/drtmoxle9/image/upload/v1761048315/reel2_znsxf4.jpg",
    },
    {
      id: 4,
      url: "https://www.instagram.com/reel/DOqacooDE6u/?igsh=YzljYTk1ODg3Zg==",
      thumbnail:
        "https://res.cloudinary.com/drtmoxle9/image/upload/v1761048317/reel3_hnkk7y.jpg",
    },
    {
      id: 5,
      url: "https://www.instagram.com/reel/DOn6jQEjKYN/?igsh=YzljYTk1ODg3Zg==",
      thumbnail:
        "https://res.cloudinary.com/drtmoxle9/image/upload/v1761048318/reel6_uwwlbd.jpg",
    },
    {
      id: 6,
      url: "https://www.instagram.com/reel/DOiOs7LDBiD/?igsh=YzljYTk1ODg3Zg==",
      thumbnail:
        "https://res.cloudinary.com/drtmoxle9/image/upload/v1761048314/reel5_sykiqt.jpg",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="collection-content">
              ...
              <p className="text-gray-400 mb-6">
                Introducing our exclusive Limited Edition Collection, a
                celebration of rare ingredients and masterful craftsmanship.
                Each fragrance in this collection is produced in small batches,
                ensuring unparalleled quality and exclusivity.
              </p>
              <p className="text-gray-400 mb-8">
                Featuring notes of rare oud, precious florals, and exotic spices
                sourced from around the world, these fragrances are designed for
        ...
        <div className="container-custom relative z-10 text-center">
          <blockquote className="max-w-4xl mx-auto">
            <p className="text-2xl md:text-3xl lg:text-4xl font-serif text-light italic mb-6">
              "A fragrance is like a signature, so that even after a person has
              left the room, their fragrance remains."
            </p>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              />
              <p className="text-gray-400 mb-6">
                EmrickScents was launched in 2025 with one simple belief: great
                perfumes should be accessible, genuine, and personal. Born out
                of a deep love for fragrance and the art behind scent-making,
                our store is dedicated to bringing you premium perfumes from
                trusted brands always 100% authentic and beautifully packaged.
                <br /> <br />
                We know how powerful scent can be the way a fragrance can evoke
                memories, enhance mood, and make an impression. That’s why at
                EmrickScents, we don’t settle for “just smells good.” Every
                perfume we stock is selected for its character, quality, and
                identity. We offer discovery sets so you can explore without
                committing, fast delivery to wherever is most convenient for
                you, and a return & store credit policy that puts your
                satisfaction first.
              </p>
              <p className="text-gray-400 mb-8">
                We are new, but we’re passionate. Our promise is to treat every
                customer like a friend: honest, thoughtful, and always here to
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <div className="max-w-md mx-auto">
            <p className="text-gray-200 mb-6">
              Our knowledgeable staff will guide you through our collections and
              help you discover the perfect scent that resonates with your
              personality.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-start space-x-4 p-6 rounded-xl bg-black/40 border border-gray-800">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Easy returns & store credit if it’s not a match. Shop with
                  confidence.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 p-6 rounded-xl bg-black/40 border border-gray-800">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Fragrance guidance from real humans, quick, friendly, and
                  expert.
                </p>
              </div>
            </div>
