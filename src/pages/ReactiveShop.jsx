...
const ReactiveShop = () => {
  ...
  useEffect(() => {
    ...
    if (prevSearchParamsRef.current === currentSearchParams) return;
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleFilterChange("isNew", !activeFilters.isNew)
                    }
                    className="hidden"
                  />
                  <label
