...
const Shop = () => {
  ...
  useEffect(() => {
    ...
    if (activeFilters.collection) {
      // This is a simplified example - in a real app, products would have collection data
                  ...
                  <div key={category.value} className="flex items-center">
                    ...
                    <label
                      ...
                      className={`cursor-pointer flex items-center text-sm ${
                        activeFilters.category === category.value ? 'text-secondary' : 'text-gray-400'
                      } hover:text-secondary transition-colors`}
                    >
                      <span className={`w-4 h-4 mr-2 border rounded-full flex items-center justify-center ${
                        activeFilters.category === category.value ? 'border-secondary' : 'border-gray-600'
                      }`}>
                ...
                {types.map((type) => (
                  <div key={type.value} className="flex items-center">
                    ...
                    <label
                      ...
                      className={`cursor-pointer flex items-center text-sm ${
                        activeFilters.type === type.value ? 'text-secondary' : 'text-gray-400'
                      } hover:text-secondary transition-colors`}
                    >
                      <span className={`w-4 h-4 mr-2 border rounded-full flex items-center justify-center ${
                        activeFilters.type === type.value ? 'border-secondary' : 'border-gray-600'
                      }`}>
