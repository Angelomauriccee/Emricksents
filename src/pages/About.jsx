          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="story-content">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Every great fragrance tells a story, and so does EmrickScents.

Our journey began with a simple passion: the belief that everyone deserves access to perfumes that are authentic, memorable, and meaningful. In 2025, that passion took shape when EmrickScents was born not just as a store, but as a movement to bring originality, luxury, and trust back into the fragrance world.
              </p>
              <p className="text-gray-300 mb-6 leading-relaxed">
                What started as a small idea to create a space where customers could confidently explore scents has grown into a community of fragrance lovers. Along the way, we’ve built relationships with trusted suppliers, carefully curated collections, and introduced discovery sets that let you find your perfect match before committing to a bottle.
              </p>
              <p className="text-gray-300 mb-8 leading-relaxed">
                But our journey is just beginning. Every step forward is inspired by you our customers who remind us why scent matters. We are committed to growing, learning, and expanding our collections while keeping one promise unchanged: to always deliver 100% genuine perfumes that spark emotions, awaken memories, and make moments unforgettable.
<br /> <br />
EmrickScents isn’t just about selling perfumes; it’s about walking this journey together one fragrance at a time.
              </p>
              <div className="flex items-center space-x-4">
                ...
                />
                <div>
                  <p className="text-light font-medium">Emrick</p>
